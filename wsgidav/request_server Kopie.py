...
#        if contentlength < 0 and not WORKAROUND_BAD_LENGTH:
        ...
        try:      
            ...
            isMac = ("Darwin" in environ.get("HTTP_USER_AGENT", "") and 
                     environ.get("HTTP_X_EXPECTED_ENTITY_LENGTH") not in (None, "0"))

            print("##### Chunked PUT: HTTP_X_EXPECTED_ENTITY_LENGTH=%r, isMac=%s" 
                  % (environ.get("HTTP_X_EXPECTED_ENTITY_LENGTH"), isMac))

            if environ.get("HTTP_TRANSFER_ENCODING", "").lower() == "chunked" and not isMac:
                # Chunked Transfer Coding
                # http://www.servlets.com/rfcs/rfc2616-sec3.html#sec3.6.1

                print("##### Chunked PUT: HTTP_X_EXPECTED_ENTITY_LENGTH=%r" 
